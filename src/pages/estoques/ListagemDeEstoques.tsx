...
import { IListagemEstoque, EstoquesService } from "../../shared/services/api/estoques/EstoquesService";
...
export const ListagemDeEstoques: React.FC = () => {
  ...
  const [rows, setRows] = useState<IListagemEstoque[]>([]);
            ...
            {rows?.map(row => (
              <TableRow key={row.id}>
                <TableCell>
                  ...
                  <IconButton size='small' onClick={() => navigate(`/estoques/detalhe/${row.id}`)}>
                    <Icon>edit</Icon>
                  </IconButton>
                </TableCell>
