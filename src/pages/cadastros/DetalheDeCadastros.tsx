...
import { CadastrosService } from "../../shared/services/api/cadastros/CadastrosService";
...
export const DetalheDeCadastros: React.FC = () => {
  ...
  useEffect(() => {
    if (id !== 'nova') {
      ...
      CadastrosService.getById(Number(id))
        .then((result) => {
          setIsLoading(false);
            ...
            .then((result) => {
              ...
              if (result instanceof Error) {
                ...
                if (isSaveAndClose()) {
                  ...
                  navigate(`/cadastros/detalhe/${result}`); //result me retorna o Id do usuário
                }
              }
            });
        } else {
  ...
  return (
    <LayoutBaseDePagina
      titulo={id === 'nova' ? 'Nova cadastro' : nome}
      barraDeFerramentas={
        <FerramentasDeDetalhe
          ...
          aoClicarEmVoltar={() => navigate('/cadastros/')}
